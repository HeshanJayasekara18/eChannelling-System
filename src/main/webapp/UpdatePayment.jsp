                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="Province" name="Province" class="form-control" value="<%= Province %>">
                            </div>
                            <div class="col-md-6">
                                <label for="zip-code">Zip Code:</label>
                                <input type="text" id="ZipCode" name="ZipCode" class="form-control" pattern="\d{5}" value="<%= ZipCode %>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="NameOnCard" name="NameOnCard" class="form-control" value="<%= NameOnCard %>">
                            </div>
                            <div class="col-md-6">
                                <label for="card-number">Card Number:</label>
                                <input type="text" id="CardNumber" name="CardNumber" class="form-control" pattern="\d{4} \d{4} \d{4} \d{4}" value="<%= CardNumber %>">
                            </div>
                            <div class="col-md-6">
                                <label for="exp-month">Exp Month:</label>
                                <select name="ExpMonth" id="exp-month" class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="ExpYear" id="exp-year" class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="CVN" name="CVN" class="form-control" pattern="\d{3}" value="<%= CVN %>">
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="PaymentRead.jsp"><button type="submit" class="btn btn-secondary">Cancel</button></a>
                        </div>
                    </div>
                </div>
            </form>
