...
<div class="container">
    ...
    <c:set var="fname" value="${admin.firstName}"/>
    ...
    <div class="actions">
        ...
        <a href="${adminupdate}" class="btn">
        <button class="btn">Update My Data</button>
        </a>
        ...
        <a href="${admindelete}" class="btn btn-danger">
        <button class="btn btn-danger">Delete my data</button><br>
