 ...
 %>
        ...
        <div class="row"> 
            <div class="col"> 
                ...
                <div class="inputBox"> 
                    ...
                    <input type="text" id="doctor-name" name="doctorName" value="<%= doctorName %>" placeholder="ex: Dr. Saman Perera">
                </div> 

                <div class="inputBox"> 
                    <label for="doctor-email">Doctor's Email:</label> 
                    <input type="email" id="doctor-email" name="doctorEmail" value="<%= doctorEmail %>" placeholder="example@gmail.com">
                </div> 
                ...
                <div class="inputBox"> 
                    ...
                    <select name="doctorSpecialization" id="doctor_specialization">
    ...
    <option value="Pediatrics" <%= "Pediatrics".equals(doctorSpecialization) ? "selected" : "" %>>Pediatrics</option>
                ...
                <div class="inputBox"> 
                    ...
                    <input type="text" id="visit-date" name="visitDate"  value="<%= visitDate %>" placeholder="ex: September 8, 2024/22.00H">
                </div> 
            ...
            <div class="col"> 
                ...
                <div class="inputBox"> 
                    ...
                    <input type="text" id="patient-fullname" name="patientFullname" value="<%= patientFullname%>" placeholder="ex: Perera">
                </div> 
                 
                <div class="inputBox"> 
                    <label for="admission-date">Admission date:</label>
                    <input type="text" id="admission-date" name="Admissiondate" value="<%= Admissiondate%>" placeholder="ex: September 8, 2024">
                </div> 

                <div class="inputBox"> 
                    <label for="patient-medical-number">Patient Medical Number:</label>
                    <input type="text" id="patient-medical-number" name="patientMedicalNumber" value="<%= patientMedicalNumber %>" placeholder="xxxx">
                </div> 

                <div class="inputBox"> 
                    <label for="reasonForAdmission">Reason for admission :</label>
                    <input type="text" id="reasonForAdmission" name="reasonForAdmission" value="<%=reasonForAdmission %>" placeholder="ex: Chest Pain">
                </div> 
    ...
    <div class="inputBox"> 
        ...
        <textarea style="border: 1px solid #000000; border-radius: 10px;" name="assessment" rows="8" cols="20"><%= assessment %></textarea>
    </div> 
                     
    <div class="inputBox"> 
        <legend style="font-size: medium;">Diagnosis</legend>
        <textarea style="border: 1px solid #000000; border-radius: 10px;" name="diagnosis" rows="8" cols="20"><%= diagnosis %></textarea>
    </div> 

    <div class="inputBox"> 
        <legend style="font-size: medium;">Prescription</legend> 
        <textarea style="border: 1px solid #000000; border-radius: 10px;" name="prescription" rows="8" cols="20"><%= prescription %></textarea>
    </div> 
</div>
        ...
        <div>
            <input type="submit" value="Update" class="submit-btn" style="background-color:rgb(136, 136, 231);color:white; border-radius: 5px; padding: 10px 20px;">
